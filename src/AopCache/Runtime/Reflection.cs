...
namespace AopCache.Runtime
{
    ...
    public static class Reflection
    {
        ...
        //{
        //    return GetDisplayNameOrDescription(TypeExtensions.GetType<T>());
        //}
        ...
        ///// <typeparam name="TInterface">接口类型</typeparam>
        ///// <param name="assemblies">待查找的程序集列表</param>
        //public static List<TInterface> GetInstancesByInterface<TInterface>(this Assembly assemblies)
        //{
        //    return FindTypes<TInterface>(assemblies)
        //        .Select(t => CreateInstance<TInterface>(t)).ToList();
        //}
        ...
        //{
        //    return ObjectExtensions.To<T>(Activator.CreateInstance(type, parameters));
        //}
