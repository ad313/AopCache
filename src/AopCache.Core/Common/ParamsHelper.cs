...
namespace AopCache.Common
{
    ...
    public static class ParamsHelper
    {
        ...
        /// 每个方法 key中的参数
        /// </summary>
        private static readonly ConcurrentDictionary<string, List<string>> KeyParamsCache = new ConcurrentDictionary<string, List<string>>();
        ...
        private static List<string> GetKeyParams(string source)
        {
            if (KeyParamsCache.TryGetValue(source, out List<string> keyArray))
                return keyArray;

            keyArray = GetKeyParamsInternal(source);

            KeyParamsCache.TryAdd(source, keyArray);
        ...
        /// <param name="source"></param>
        /// <returns></returns>
        private static List<string> GetKeyParamsInternal(string source)
        {
