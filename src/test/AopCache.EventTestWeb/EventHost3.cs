...
{
    public class EventHost3 : BackgroundService
    {
        ...
        public EventHost3(IEventBusProvider eventBusProvider, RabbitMqConfig config,ISerializerProvider serializerProvider)
        {
